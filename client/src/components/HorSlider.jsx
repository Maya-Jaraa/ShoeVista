...
const HorSlider = ({ product, home }) => {
  ...
  const { img, title, sellPrice, mrp, discount, brand, category, rating } =
    product;
  //THE DATA ATTREBUTES IN TOP SELLER DOESNT MATCH WITH THIS ATTRIBUTES SO WE NEED TO CHANGE THEM AND WE NEED MORE TIME FORM THIS BUT I WILL EXPLAIN , WE ADD THE DATA IN HOME AND PASS IT AS A PROP TO COMPONENTS
